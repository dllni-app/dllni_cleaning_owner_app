...
void main() {
  group('FetchOrdersUsecaseModel', () {
    test(
      'parses order 73 with breakdown, services, and dispatch eligibility',
      () {
        final model = fetchOrdersUsecaseModelFromJson(<String, dynamic>{
          'data': <Map<String, dynamic>>[
            <String, dynamic>{
              ...
              'cleaning_services': <String>['تنظيف عميق', 'تنظيف المكاتب'],
        ...
        expect(
          order.propertyDetails?.address,
          'حلب - Bustan al-Pasha district',
        );
    ...
    test('does not use bedrooms aggregate for bedroom count', () {
      final order = fetchOrdersUsecaseModelDataItemFromJson(<String, dynamic>{
        'propertyDetails': <String, dynamic>{
          'bedrooms': 19,
          'room_size_breakdown': <String, dynamic>{
            'bedroom': <String, dynamic>{'large': 1, 'small': 1, 'medium': 1},
          },
        },
        'numberOfRooms': 19,
      });
    ...
    test('exposes neighborhood name for pre-acceptance address display', () {
      final order = fetchOrdersUsecaseModelDataItemFromJson(<String, dynamic>{
        'status': 'pending',
        'neighborhoodName': 'الفرقان',
        'propertyDetails': <String, dynamic>{'address': '-'},
      });
