...
void main() {
  group('worker schedule reconciliation', () {
    test(
      'selects the next valid session and clears removed security state',
      () {
    ...
    test(
      'clears selection and security state when no scoped sessions remain',
      () {
    ...
    test(
      'stops location tracking when the actively tracked session is removed',
      () {
        final schedule = _schedule(
          sessions: const [
            {
    ...
    test(
      'keeps a valid selected and tracked session when a sibling changes',
      () {
        final schedule = _schedule(
          sessions: const [
            {
