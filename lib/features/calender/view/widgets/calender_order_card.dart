              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 12),
                    dataRow(Assets.imagesOrderCardCalender, 'جدولة الحجز', date.scheduledDate ?? ''),
                    SizedBox(height: 12),
                    dataRow(Assets.imagesOrderCardBuilding, 'نوع العقار', date.propertyType ?? ''),
                    SizedBox(height: 12),
                    dataRow(Assets.imagesOrderCardAlarm, 'المساحة التقديرية', date.estimatedSqm == null ? '' : '${date.estimatedSqm} متر مربع'),
                    SizedBox(height: 12),
                    Divider(height: 1, color: context.surface),
                    SizedBox(height: 12),
                    Padding(
